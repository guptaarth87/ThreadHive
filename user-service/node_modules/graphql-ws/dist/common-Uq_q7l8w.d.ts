...
/** @category Common */
interface ExecutionPatchResult<Data = unknown, Extensions = Record<string, unknown>> {
    errors?: ReadonlyArray<GraphQLError> | undefined;
    data?: Data | null | undefined;
...
/** @category Common */
interface FormattedExecutionPatchResult<Data = unknown, Extensions = Record<string, unknown>> {
...
export { CloseCode as C, DEPRECATED_GRAPHQL_WS_PROTOCOL as D, type ExecutionResult as E, type FormattedExecutionResult as F, GRAPHQL_TRANSPORT_WS_PROTOCOL as G, type ID as I, type JSONMessageReviver as J, MessageType as M, type NextMessage as N, type PingMessage as P, type Sink as S, type Disposable as a, type ConnectionInitMessage as b, type ConnectionAckMessage as c, type PongMessage as d, type SubscribeMessage as e, type SubscribePayload as f, type ExecutionPatchResult as g, type FormattedExecutionPatchResult as h, type ErrorMessage as i, type CompleteMessage as j, type Message as k, type JSONMessageReplacer as l, parseMessage as p, stringifyMessage as s, validateMessage as v };
