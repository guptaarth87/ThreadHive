 ...
 */
export declare function getFullyQualifiedNameRaw(context: Rule.RuleContext, node: estree.Node, fqn: string[], scope?: Scope.Scope, visitedVars?: Scope.Variable[]): string | null;
/**
