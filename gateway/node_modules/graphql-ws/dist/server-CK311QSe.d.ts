...
import { E as ExecutionResult, g as ExecutionPatchResult, b as ConnectionInitMessage, f as SubscribePayload, h as FormattedExecutionPatchResult, J as JSONMessageReviver, l as JSONMessageReplacer, P as PingMessage, d as PongMessage, I as ID, G as GRAPHQL_TRANSPORT_WS_PROTOCOL } from './common-Uq_q7l8w.js';
...
/** @category Server */
type OperationResult = Promise<AsyncGenerator<ExecutionResult | ExecutionPatchResult> | AsyncIterable<ExecutionResult | ExecutionPatchResult> | ExecutionResult> | AsyncGenerator<ExecutionResult | ExecutionPatchResult> | AsyncIterable<ExecutionResult | ExecutionPatchResult> | ExecutionResult;
/**
...
interface ServerOptions<P extends ConnectionInitMessage['payload'] = ConnectionInitMessage['payload'], E = unknown> {
     ...
     * in the close event reason.
     */
    onNext?: undefined | ((ctx: Context<P, E>, id: string, payload: SubscribePayload, args: ExecutionArgs, result: ExecutionResult | ExecutionPatchResult) => Promise<FormattedExecutionResult | FormattedExecutionPatchResult | void> | FormattedExecutionResult | FormattedExecutionPatchResult | void);
    /**
