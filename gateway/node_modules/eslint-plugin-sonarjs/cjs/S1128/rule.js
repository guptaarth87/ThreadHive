        ...
        const ruleListener = {
            ...
            'Program:exit': () => {
                ...
                unusedImports
                    ...
                    !(vueIdentifiers.has(unused.name) && (0, index_js_1.isInsideVueSetupScript)(unused, context)) &&
...
function getSuggestion(context, { id, importDecl }) {
    ...
    if (variables.length === 1) {
        return {
            ...
            fix: fixer => {
                return (0, index_js_1.removeNodeWithLeadingWhitespaces)(context, importDecl, fixer);
            },
        };
    }
